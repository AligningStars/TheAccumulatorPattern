...
def run_test_factorial():
    ...
    print('       answer (from my code): ', answer_from_my_code)
    ...
    # Test 5:
    answer_from_oracle = math.factorial(77)
    answer_from_my_code = factorial(77)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 3
    answer = count_cosines_from(2, 7, 0.27)
    print('Test 4 expected:', expected)
    print('       answer:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(3, 6, 0.47)
    print('Test 5 expected:', expected)
    print('       answer:  ', answer)

    # Test 6:
    expected = 3
    answer = count_cosines_from(1, 9, 0.33)
